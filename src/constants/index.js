...
export const STABEL_FEE = 0.0004
...
let client = 'https://graph-meter.voltswap.finance/subgraphs/name/meterio/voltswapv2-upgrade-subgraph'
...
export const HEALTH_CLIENT = healthClient
export const BLOCK_CLIENT = blockClient
