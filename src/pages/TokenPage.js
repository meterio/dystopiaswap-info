...
import { UNTRACKED_COPY, TOKEN_BLACKLIST, BLOCKED_WARNINGS, SCAN_URL } from '../constants'
      ...
      <BlockedWrapper>
        <BlockedMessageWrapper>
          <AutoColumn gap="1rem" justify="center">
            ...
            <Link external={true} href={`${SCAN_URL}address/` + address}>{`More about ${shortenAddress(
              address
            )}`}</Link>
          </AutoColumn>
        </BlockedMessageWrapper>
              ...
              >
                <TokenDetailsLayout>
                  ...
                  <ButtonLight color={backgroundColor}>
                    <Link color={backgroundColor} external href={`${SCAN_URL}address/` + address}>
                      View on Meterscan ↗
                    </Link>
                  </ButtonLight>
                </TokenDetailsLayout>
